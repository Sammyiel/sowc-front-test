...
var baseUrl = "https://sowc-database-and-api.herokuapp.com";

$(document).ready(function() {
    $.ajax({
        type: "GET",
        url: baseUrl + "/resource/topic/Non-Timber Forest Products",
        cache: false,
...
function updateFormRecord(data) {
    ...
    $.ajax({
        type: 'PUT',
        url: baseUrl + "/resource/topic/" + selectedRecordID,
        dataType: 'json',
        data: updateData,
        contentType: "application/json; charset=utf-8",
        cache: false,
